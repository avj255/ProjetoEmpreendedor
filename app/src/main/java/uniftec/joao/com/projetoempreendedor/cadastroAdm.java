...
public class cadastroAdm extends ActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_adicionaradministrador);
        edtCpf= (EditText) findViewById(R.id.editTextCpfAdm);
        edtUsuario= (EditText) findViewById(R.id.edtitTextCadastroUsuarioAdm);
        edtEmail= (EditText) findViewById(R.id.editTextEmailAdm);
        edtConfirmaEmail= (EditText) findViewById(R.id.editTextConfirmaEmailAdm);
        edtNome= (EditText) findViewById(R.id.editTextNomeAdm);
        edtSenha= (EditText) findViewById(R.id.editTextSenhaAdm);
        edtConfirmaSenha= (EditText) findViewById(R.id.editTextConfirmaSenhaAdm);
        progressBarCadastro = findViewById(R.id.progressBarCadastroAdm);
        edtCadastroInvalido = findViewById(R.id.textViewCadastroInválidoAdm);
    ...
    public void CadastrarNovoUsuarioAdm(View view)
    {
        if (validaCampos())
        {
    ...
    public void CancelarAdm(View view)
    {
        Intent i = new Intent(this, administradores.class);
        startActivity(i);
        finish();
